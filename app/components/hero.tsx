                    ...
                    <div className="mt-10">
                        ...
                        <div className="mt-6 sm:max-w-xl">
                            ...
                            <p className="mt-6 text-lg text-gray-500">
                                Never send your email to any free services, Blade Mail will handle emails testing for
                                you.
                            </p>
                        </div>
                            ...
                            <div
                                ...
                                <div className="flex w-full gap-2">
                                    ...
                                    <a
                                        role="button"
                                        href={downloadUrl}
                                        className="block w-full transition-colors md:w-auto rounded-md border border-transparent px-5 py-3 bg-yellow-400 text-base font-medium text-white shadow hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:px-10"
                                    >
                                        Free download
                                    </a>
                                </div>
                                <a
                                    ...
                                    className="block w-full transition-colors md:w-auto rounded-md border border-transparent px-5 py-3 bg-rose-500 text-base text-center font-medium text-white shadow hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:px-10"
                                >
                                    Buy now
                                </a>
                            </div>
