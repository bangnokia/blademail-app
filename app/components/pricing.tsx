            ...
            <div className="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-3xl lg:mx-auto">
                ...
                <div className="border border-rose-500 rounded-lg shadow-lg divide-y divide-gray-200">
                    <div className="p-6">
                        ...
                        <a href="#" className="mt-8 block w-full bg-rose-500 border border-transparent rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-rose-600 transition-colors">Support us</a>                    </div>
                    <div className="pt-6 pb-8 px-6">
